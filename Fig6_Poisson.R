...
if (spikeCov){
  if (alpha_elnet == 1) {
    pdf(sprintf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/poisson_lasso_spiked_n_%s_p_%s_k_%s.pdf", n,p,k))
  } else {
    pdf(sprintf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/poisson_elnet_spiked_n_%s_p_%s_k_%s.pdf", n,p,k))
  }
} else {
  if (alpha_elnet == 1) {
    pdf(sprintf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/poisson_lasso_toeplitz_n_%s_p_%s_k_%s.pdf", n,p,k))
  } else {
    pdf(sprintf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/poisson_elnet_toeplitz_n_%s_p_%s_k_%s.pdf", n,p,k))
  }
}
print(eror.plot)
dev.off()
