...
if (delta < 1) {
  if (alpha_elnet == 1) {
    pdf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_lasso_p_greater_n.pdf")
  } else {
    pdf("/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_elnet_p_greater_n.pdf")
  }
} else {
  if (delta > 1){
    if (alpha_elnet == 1) {
      pdf( "/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_lasso_p_less_n.pdf")
    } else {
      pdf( "/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_elnet_p_less_n.pdf")
    }
  } else {
    if (alpha_elnet == 1) {
      pdf( "/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_lasso_p_equal_n.pdf")
    } else {
      pdf( "/Users/krad/Dropbox/Fast LOOCV/ALO_JRSSB/figures/time_logistic_elnet_p_equal_n.pdf")
    }
  }
}
